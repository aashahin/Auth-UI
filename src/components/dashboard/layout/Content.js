...
// Components
const FirstTopContent = dynamic(() => import("@/components/dashboard/overview/FirstTopContent"), {
    ssr: false,
  loading: ()=> <Loading/>,
});
const MiddleContent = dynamic(() => import("@/components/dashboard/overview/MiddleContent"), {
    ssr: false,
    loading: ()=> <Loading/>,
});
const BottomContent = dynamic(() => import("@/components/dashboard/overview/BottomContent"), {
    ssr: false,
    loading: ()=> <Loading/>,
});
