import {
  UilChartPieAlt,
  UilFilePlus, UilFolderOpen, UilFolderPlus,
  UilNotebooks,
  UilNotes,
...
export default function SidebarDashBoard({ toggleCollapse }) {
  const { articles, allArticles, addArticle,tags,allTags,addTag, comments, dashboard } =
  ...
  return (
    <>
      <div
        className={
          toggleCollapse
            ? "fixed z-40 pt-20 h-screen block w-64 pt-8 pb-4 bg-white text-gray-900 flex justify-between flex-col border border-orange-500 border-l-0 border-b-0 dark:bg-gray-900 dark:text-gray-200"
